...
const Codewars = () => {
    return ( 
        <div className="w-full px-10 md:px-36 2xl:px-56 min-h-screen xl:h-screen py-36 xl:py-0 bg-[#121212] flex flex-col md:flex-row justify-center text-neutral-300 md:space-x-20 xl:space-x-32 items-center space-y-10">
            <img src="assets/img/icon/codewars.svg" className="w-full md:w-72 xl:w-96"/>
            <div className="flex flex-col space-y-10 w-full xl:w-[38%]">
                <div className="flex flex-col">
                    <span className="text-sm text-purple-500">coding challenges</span>
                ...
                <a href="https://www.codewars.com/users/codewithgi" className="hover:text-purple-500 duration-200 cursor-pointer flex items-center group" target="_blank">
